...
<s:if test="#request.dim.type == 'day'">
	...
	<p/>
	开始时间： <input type="text" class="inputform2 Wdate" size="20" value="${dft2}" id="dft2" name="dft2" readonly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'2012-01-01', maxDate:'${maxdt}'})"> <p/>
	结束时间： <input type="text" class="inputform2 Wdate"  size="20" value="${dft1}" id="dft1" name="dft1" readonly="true" onclick="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'2012-01-01', maxDate:'${maxdt}'})">
	</div>
</s:if>
