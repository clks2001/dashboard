<%@ page language="java" contentType="text/html; charset=utf-8" import="com.ruisi.vdop.util.VDOPUtils"
    pageEncoding="utf-8"%>
...
<s:if test="#request.pageInfo == null || #request.pageInfo == ''">
...
<!--              <a href="javascript:setpagestyle();" id="mb5" class="easyui-linkbutton" plain="true" iconCls="icon-styles">样式</a> -->
                <%if(VDOPUtils.isShowMenu("export", request)){%>
