...
function savecubecfg(pageJson, update){
	...
	for(i=0; i<dims.length; i++){
		...
		if(d.attributes.tp == "group"){
			...
			var obj = {name:d.attributes.dispName, type:d.attributes.dimtype,col:d.attributes.col, tname:d.attributes.tname, alias:d.attributes.alias, vtype: d.attributes.vtype, colTable:d.attributes.colTable,colkey:d.attributes.colkey,coltext:d.attributes.coltext,ordcol:d.attributes.ordcol,dimord:d.attributes.dimord, dateformat:d.attributes.dateformat,calc:(d.attributes.calc?d.attributes.calc:false),targetId:d.attributes.targetId,isupdate:d.attributes.isupdate};
	...
	for(i=0; i<kpis.length; i++){
		var t = kpis[i];
		cubeKpi.push({name:t.attributes.dispName,col:t.attributes.col,tname:t.attributes.tname,alias:t.attributes.alias,fmt:t.attributes.fmt,unit:t.attributes.unit,aggre:t.attributes.aggre,kpinote:t.attributes.kpinote,calc:(t.attributes.calc?t.attributes.calc:false),calcKpi:t.attributes.calcKpi,targetId:t.attributes.targetId,isupdate:t.attributes.isupdate});
	}
	pageJson.dim = cubeDim;
	pageJson.kpi = cubeKpi;
	if(update){
